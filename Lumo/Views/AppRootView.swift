...
struct AppRootView: View {
    ...
    private let costFetcher: CostFetching
    private let intentsFetcher: IntentsFetching
    ...
    init(
        ...
        self.costFetcher = costFetcher
        self.intentsFetcher = intentsFetcher
